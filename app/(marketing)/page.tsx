...
export const metadata: Metadata = {
  ...
  description:
    'We create street interview videos that work as UGC-style ads in an authentic short-form content format for brands running TikTok, Instagram, Reels, Shorts, and Meta campaigns.',
        ...
        <div className="relative flex-1 max-w-site mx-auto w-full px-6 lg:px-12 pt-24 lg:pt-32 pb-16 lg:pb-24 [@media(max-height:760px)]:pt-20 [@media(max-height:760px)]:pb-12 flex flex-col justify-center">
          <div className="max-w-3xl">
            ...
            <p className="text-lead text-white/85 max-w-2xl mb-8 [@media(max-height:760px)]:mb-6">
              We create street interview videos that work as UGC-style ads in an authentic short-form content format for brands running
