...
export function ScrollIndicator({ targetId = 'next-section' }: { targetId?: string }) {
  ...
  return (
    <button
      ...
      className="absolute bottom-6 lg:bottom-8 left-1/2 -translate-x-1/2 z-20 group hidden sm:inline-flex flex-col items-center text-white/70 hover:text-white transition"
    >
