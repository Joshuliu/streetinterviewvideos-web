...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    meta: 'Testimonial video production, street-interview style. Real strangers react to your product on camera, high-quality testimonial-style proof that builds trust, social-first and ad-ready.',
    shortLabel: 'Testimonial Video',
    navLabel: 'Testimonial Video Production',
    cardBlurb: 'Testimonial-style proof without stiff corporate interviews. Real strangers, real reactions, on the street.',
    ...
    hero: {
      ...
      sub: 'Testimonial-style proof, street-interview style. We put your product in front of real strangers and film what they actually say. No studio, no suit-and-chair shoot.',
    },
    problem: {
      ...
      body: [
        ...
        'We take a different path. Instead of filming your existing customers in a studio, we put your product in front of real strangers on the street and capture their unrehearsed reactions. The result works like a testimonial, feels like content, and is impossible to read as scripted.',
      ],
    },
    solution: {
      h2: 'How we make testimonial-style video that actually builds trust',
      pillars: [
        { title: 'Real strangers, not coached customers', body: 'No one on camera was briefed, cast, or paid to praise the product. The interview footage we capture sounds like real people because it is, and audiences can tell on first watch.' },
        { title: 'Unprompted lines you can’t write', body: '"Like a baby floating in a cloud." "Wait, that’s only $26?" The strongest proof moments in our library are lines nobody scripted. That is what the street format produces and a studio shoot can’t.' },
    ...
    formats: {
      h2: 'Testimonial-style video formats we produce',
      items: ['Street interview testimonials', 'On-product reaction shoots', 'Blind tests and price-reveal reactions', 'Multi-voice testimonial montages', 'Scripted actor-led testimonial-style ads', 'Social-proof cutdowns for retargeting'],
    },
    useCases: {
      h2: 'When testimonial-style videos work best',
    ...
    examplesIntro: 'Recent testimonial-style and reaction videos produced in a street-interview format.',
    included: [
      '5–15 real-stranger reactions per shoot day',
    ...
    process: PROCESS_DEFAULT,
    faq: [
      { q: 'Do you film our existing customers?', a: 'No. We don’t run studio testimonial shoots with your customer list. We capture real strangers reacting to your product on the street, which works like a testimonial but reads as content. If you need a fully controlled message, our scripted street interview format uses actors with the same feed-native style.' },
      { q: 'How is this different from classic testimonial video production?', a: 'Classic testimonial production films people who already bought from you, in a controlled setting. We film people meeting your product for the first time, in public. The trust signal is stronger because the reaction is verifiably unrehearsed.' },
      { q: 'Will testimonials feel scripted?', a: 'No. Nobody on camera gets lines. We edit for the moments that sound like a real person, not a polished brand spot.' },
      { q: 'How many testimonial-style clips per shoot?', a: '5–15 per day depending on location, shoot length, and prompt list.' },
      { q: 'Can we use these as testimonials on our landing page?', a: 'Yes. Every package ships landing-page-ready cuts alongside the ad exports, and every on-camera person signs a release.' },
