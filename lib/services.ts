...
export const SERVICES: Service[] = [
  {
    ...
    priority: 0,
    title: 'Social Media Video Production for Brands | StreetInterviewVideos.com',
    h1: 'Social Media Video Production for Brands',
    meta: 'We create short-form social media videos for brands using street interviews, UGC-style ads, real reactions, captions, hooks, and platform-ready edits.',
    ...
    solution: {
      h2: 'Real-person video, built for social-first feeds',
      pillars: [
        { title: 'Native by default', body: 'We shoot vertical, edit fast, and design for sound-on or sound-off. Your video looks like the rest of the feed.' },
        { title: 'Format flexibility', body: 'Street interviews, UGC, reactions, podcast clips, founder prompts. We pick the format that fits the goal.' },
        { title: 'Scaled creative', body: 'Multiple hooks per video, multiple cuts per shoot, organized into ad-account-ready folders.' },
      ],
    },
    formats: {
      h2: 'Formats we produce',
    ...
    useCases: {
      h2: 'Best for',
      items: ['Product launches', 'Paid ad testing', 'TikTok campaigns', 'Meta ad campaigns', 'Organic social', 'Event activations'],
    },
    ...
    related: ['branded-video-production', 'testimonial-video-production', 'ugc-video-ads'],
  },
  {
    slug: 'branded-video-production',
    priority: 0,
    title: 'Branded Video Production That Feels Like Real Content',
    h1: 'Branded Video Production That Feels Real',
    meta: 'We create branded video content using street interviews, real reactions, and social-first editing — branded content that feels like content first, advertising second.',
    ...
    hero: {
      ...
      headline: 'Branded Video That Feels Like Real Content',
      sub: 'Most branded videos feel like ads. Ours feel like content people actually watch — built around street interviews and real reactions.',
    },
    problem: {
      h2: 'Most branded videos feel like ads. Audiences know.',
      body: [
        'When branded content looks polished, audiences disengage. They’ve been trained by 15 years of skip buttons.',
        'Your brand doesn’t need a commercial. It needs content the algorithm rewards and viewers actually watch.',
      ],
    },
    solution: {
      h2: 'Branded content that feels native first, branded second',
      pillars: [
        { title: 'Content-first storytelling', body: 'Every video opens with a real moment, not a logo. Brand integration happens after the hook works.' },
        { title: 'Real-person formats', body: 'Street interviews, public reactions, founder voiceovers. Authenticity is a production decision, not a buzzword.' },
        { title: 'Built for the feed', body: 'Vertical, fast-paced, captioned, optimized for sound-on and sound-off. Native to TikTok, Reels, Shorts, Meta.' },
      ],
    },
    formats: {
    ...
    useCases: {
      h2: 'Best campaigns for branded video',
      items: ['Brand awareness', 'New brand launches', 'Repositioning campaigns', 'Always-on social', 'Brand storytelling for paid ads', 'Mid-funnel education'],
    },
    ...
    faq: [
      ...
      { q: 'Can branded video drive performance?', a: 'Yes. Branded video built for social feeds outperforms polished commercials on CTR and watch time, especially on TikTok and Reels.' },
      ...
      { q: 'Do you produce traditional brand films?', a: 'We can. But we’ll always recommend the street-interview-led version unless your distribution plan is TV or out-of-home.' },
      ...
      { q: 'How long are typical branded videos?', a: '15–60 seconds for social, 60–90 seconds for landing pages, 2–3 minutes for brand films.' },
    ],
    internalLinks: [
    ...
    related: ['social-media-video-production', 'branded-content-video-production', 'brand-video-production'],
  },
  {
    slug: 'testimonial-video-production',
    priority: 0,
    title: 'Testimonial Video Production That Feels Authentic',
    h1: 'Testimonial Video Production for Brands',
    meta: 'We create testimonial-style videos using street interviews, customer reactions, and social-first editing so your proof feels believable, natural, and ad-ready.',
    ...
    hero: {
      ...
      sub: 'Testimonial-style proof without stiff corporate interviews. Built for social feeds and paid ads.',
    },
    problem: {
      h2: 'Traditional testimonial videos feel stiff. Viewers skip.',
      body: [
        'Most testimonial videos look like a board meeting recorded badly. Suit, chair, plant in the corner. Nobody finishes them.',
        'Buyers want proof, but proof has to feel real. The format is broken — not the idea.',
      ],
    },
    solution: {
      h2: 'Testimonial-style street interviews and customer reactions',
      pillars: [
        { title: 'Street-interview style', body: 'We capture testimonials in the wild — at events, in stores, in the city. Lighting moves. Energy stays.' },
        { title: 'Customer reactions', body: 'Real customers reacting to your product on camera, edited for social feeds and paid ads.' },
        { title: 'Actor-led testimonials', body: 'When a customer schedule won’t work, we cast actors and run a real testimonial structure with prompts you approve.' },
      ],
    },
    formats: {
      h2: 'Testimonial formats we produce',
      items: ['Street interview testimonials', 'Customer reaction videos', 'On-product reaction shoots', 'Actor-led scripted testimonials', 'Event activation testimonials', 'Multi-customer testimonial montages'],
    },
    useCases: {
      h2: 'Best use cases',
      items: ['Landing page social proof', 'Paid ad creative', 'TikTok and Meta retargeting', 'Brand trust at activations', 'Sales and demo decks', 'Email and SMS nurture sequences'],
    },
    examplesIntro: 'Recent testimonial-style videos produced in a street-interview format.',
    included: COMMON_INCLUDED,
    process: PROCESS_DEFAULT,
    faq: [
      ...
      { q: 'Will testimonials feel scripted?', a: 'Not unless you want them to. We give prompts, not scripts, and edit for the moments that feel most real.' },
    ...
    related: ['customer-testimonial-video-production', 'video-testimonial-production', 'street-interview-video-ads'],
  },
  {
    slug: 'ugc-video-ads',
    priority: 0,
  ...
  },
  {
    ...
    priority: 0,
    title: 'Street Interview Video Ads for Brands',
    ...
    related: ['social-media-video-production', 'ugc-video-ads', 'video-ad-production'],
  },
  {
    slug: 'video-ad-production',
    priority: 1,
    title: 'Video Ad Production for TikTok, Instagram, and Meta',
    ...
    related: ['social-media-video-production', 'ugc-video-ads', 'tiktok-video-ads'],
  },
  {
